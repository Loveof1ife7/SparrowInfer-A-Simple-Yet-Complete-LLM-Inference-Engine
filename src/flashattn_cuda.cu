...
// void launch_fa_warp_double_buffer(
//     half *Q, half *K, half *V, half *out, int B, int H, int N, int D);
...
torch::Tensor flash_attention_forward_v3(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v)
{
...
torch::Tensor flash_attention_forward_v4(
    torch::Tensor q,
    torch::Tensor k,
    torch::Tensor v)
{
...
// torch::Tensor flash_attention_forward_v6(
//     torch::Tensor q,
//     torch::Tensor k,
//     torch::Tensor v)
// {
